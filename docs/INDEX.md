...
- [Governança da documentação](00-governance/DOCUMENTATION-GOVERNANCE.md)
- [Glossário](00-governance/GLOSSARY.md)
- [Registro de mudanças](00-governance/CHANGELOG.md)
...
- [Releases](01-product/RELEASE-PLAN.md)

## 02 — Arquitetura

- [Arquitetura do sistema](02-architecture/SYSTEM-ARCHITECTURE.md)
- [Modelo de dados e estado](02-architecture/DATA-AND-STATE.md)
- [Integrações e contratos](02-architecture/INTEGRATION-CONTRACTS.md)
- [Implantação](02-architecture/DEPLOYMENT-ARCHITECTURE.md)
...
- [Backlog](04-delivery/BACKLOG.md)
- [Plano de execução](04-delivery/EXECUTION-PLAN.md)
- [Validação da baseline — 23/07/2026](04-delivery/BASELINE-VALIDATION-2026-07-23.md)

## 05–08 — Operação e qualidade

- [Desenvolvimento](05-operations/DEVELOPMENT.md)
...
- [Template de SPEC](templates/SPEC-TEMPLATE.md)
